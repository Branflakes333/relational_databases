...
COPY tweets
FROM '/Users/brandonminer/usf/relational_databases/data/tweets.csv'
DELIMITER ','
CSV HEADER;

-- What is the column type of tweet?
SELECT DISTINCT pg_typeof(tweet) FROM tweets;
...
WHERE daily_aqi_value > 200
ORDER BY daily_aqi_value;
